...
export const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-t from-green-900 to-green-800 py-16 overflow-hidden">
      {/* Subtle leaf pattern background */}
      <div className="absolute inset-0 opacity-10">
        <Image
          src="/footer-leaf-pattern.jpg"  // ← Your image here (in public/ folder)
          alt="Soft leaf pattern background - symbolizing growth and healing"
          fill
      ...
      <div className="relative container mx-auto px-4 z-10">
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link href="/services" className="text-white hover:text-gray-300 transition">Services</Link></li>
              <li><Link href="/contact" className="text-white hover:text-gray-300 transition">Contact</Link></li>
              <li><Link href="/privacy-policy" className="text-white hover:text-gray-300 transition">Privacy Policy</Link></li>
            </ul>
          </div>
            ...
            <ul className="space-y-4">
              <li className="flex items-center gap-3">
                ...
                <div className="text-white">
                  <a href="tel:+254110707361" className="hover:text-gray-300 font-medium">0110707361</a>
                  <span className="mx-2">/</span>
                  <a href="tel:+254110003924" className="hover:text-gray-300 font-medium">0110003924</a>
                </div>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-white" />
                <a href="mailto:u4uwellnesscenter@gmail.com" className="text-white hover:text-gray-300">
                  u4uwellnesscenter@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-white mt-0.5" />
                <span className="text-white">Nakuru, Kenya</span>
              </li>
              <li className="flex items-center gap-3">
                <Clock className="w-5 h-5 text-white" />
                <span className="text-white">Mon–Fri: 9AM–7PM • Sat: 10AM–3PM</span>
              </li>
            </ul>
          </div>
            ...
            <div>
              ...
              <div className="flex gap-5">
                <a
                  ...
                  aria-label="Follow U4U on LinkedIn"
                >
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="social-icon"
                  aria-label="Follow U4U on TikTok"
                >
                  <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="social-icon"
                  aria-label="Follow U4U on Instagram"
                >
                  <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="social-icon"
                  aria-label="Subscribe to U4U on YouTube"
                >
                  <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Bottom */}
        <div className="mt-12 pt-8 border-t border-green-600 text-center relative z-10">
