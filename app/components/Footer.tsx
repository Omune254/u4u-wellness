          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.tiktok.com/@u4uwellnesscenter?_r=1&_t=ZM-92OoOCvGiqq" target="_blank" rel="noopener" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition">
                ...
                <a href="https://www.instagram.com/u4uwellnesscenter?igsh=MWtzZTJoajc4NWdlcA==" target="_blank" rel="noopener" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition">
