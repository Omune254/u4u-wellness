        ...
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-3 group">
              ...
              <span className="font-bold text-2xl text-white">U4U</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/" className="text-green-100 hover:text-white transition">Home</Link></li>
              <li><Link href="/about" className="text-green-100 hover:text-white transition">About</Link></li>
              ...
              <li><Link href="/privacy-policy" className="text-green-100 hover:text-white transition">Privacy Policy</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="mailto:u4uwellnesscenter@gmail.com" className="text-green-100 hover:text-white">
                  u4uwellnesscenter@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-green-200 mt-0.5" />
                <span className="text-green-100">Nakuru, Kenya</span>
              </li>
              <li className="flex items-center gap-3">
                <Clock className="w-5 h-5 text-green-200" />
                <span className="text-green-100">Mon–Fri: 9AM–7PM • Sat: 10AM–3PM</span>
              </li>
            </ul>
          </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                ...
                <a href="https://www.tiktok.com/@u4uwellnesscentre" target="_blank" rel="noopener" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition">
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M19.58 7.05c-1.35-1.54-2.02-3.48-1.86-5.51h-4.67v11.59c0 2.05-1.66 3.71-3.71 3.71-2.05 0-3.71-1.66-3.71-3.71 0-2.05 1.66-3.71 3.71-3.71.34 0 .67.05 1 .14v-4.58c-3.33.27-6 3.08-6 6.48 0 3.58 2.91 6.48 6.48 6.48 3.58 0 6.48-2.91 6.48-6.48v-5.82c1.35 1.02 3 1.61 4.85 1.61v-4.67c-1.65 0-3.12-.73-4.11-1.88z"/></svg>
                </a>
                <a href="https://www.instagram.com/u4uwellnesscenter" target="_blank" rel="noopener" className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-white/20 transition">
